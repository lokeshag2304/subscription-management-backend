...
<body>
    <div style="padding: 40px 20px;">
        <div class="email-container">
            <!-- Header with blue gradient (same as previous design) -->
            <div class="header">
                <img src="{{ $companyLogo }}" alt="Logo" class="logo-img">
                <h1 style="color: white; margin: 15px 0 0; font-size: 24px; font-weight: 500;">Ticket Closed Successfully</h1>
            </div>
            ...
            <div class="content">
                ...
                <p style="color: #4A5568; font-size: 15px; line-height: 1.6; margin-bottom: 25px;">
                    Your ticket has been marked as <strong style="color: #2C5282;">Closed</strong>. Please review the summary below for reference.
                </p>

                <!-- Ticket Details Card -->
                <div class="ticket-card">
                    <h3 style="margin-top: 0; margin-bottom: 20px; color: #2C5282; font-size: 18px; font-weight: 600;">Ticket Summary</h3>
                    <table style="width: 100%; border-collapse: collapse;">
                        ...
                        <tr>
                            ...
                            <td style="padding: 8px 0; color: #2C5282; font-size: 14px; font-weight: 500;">Closed</td>
                        </tr>
                        <tr>
                            <td style="padding: 8px 0; color: #718096; font-size: 14px;"><strong>Closed By:</strong></td>
                            <td style="padding: 8px 0; color: #2D3748; font-size: 14px; font-weight: 500;">{{ $closedBy }}</td>
                        </tr>
                        <tr>
                            <td style="padding: 8px 0; color: #718096; font-size: 14px;"><strong>Closed On:</strong></td>
                ...
                <div class="footer">
                    ...
                    <p style="color: #A0AEC0; font-size: 12px; margin-top: 15px;">
                        If you're satisfied with the resolution, please consider rating your support experience.
                    </p>
                </div>
            </div>
        </div>
