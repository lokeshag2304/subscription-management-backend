 ...
 */
class SSLImport extends SmartImporter implements \Maatwebsite\Excel\Concerns\WithHeadingRow
{
    ...
    protected function existingDupKeys(array $parsedRows): array
    {
        ...
        DB::table('s_s_l_s')->select(['domain_master_id', 'product_id', 'vendor_id', 'renewal_date', 'client_id'])
