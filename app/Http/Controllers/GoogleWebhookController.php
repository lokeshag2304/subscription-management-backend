        ...
        if ($result['success']) {
            ...
            if(!empty($agent_data->subadmin_id)){
                ...
                if($creator_data->login_type==4){
                    return redirect(env('FRONTENDURL') . "/SubAdmin/agent-management");
                }else {
                    return redirect(env('FRONTENDURL') . "/SuperAdmin/agent-management");
                }
            }
        } else {
        ...
        foreach ($notifications as $notification) {
            ...
            // if ($message) {
                ...
                $payload = [
                    ...
                    'customer_password' => '', // SECURITY: Never include plaintext password in payloads
                ...
                $response = Http::withHeaders([
                 ...
                 // Convert payload to JSON string for Postman
                        ...
                        $payloadForLog['customer_password'] = '********'; // Masked for security logs
                        $jsonPayload = json_encode($payloadForLog, JSON_PRETTY_PRINT);
